    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        public async Task<IActionResult> RegisterPerson([FromBody] UserModel Users)
        {
            var existingUser = await _context.Users
                .FirstOrDefaultAsync(u => u.UserEmail == Users.UserName);
        ...
        public IActionResult Login([FromBody] UserModel Users)
        {
            ...
            if (Users == null || string.IsNullOrEmpty(Users.UserName) || string.IsNullOrEmpty(Users.UserPassword))
                return BadRequest("Username and password are required.");

            var user = _context.Users.FirstOrDefault(u => u.UserEmail == Users.UserName);

            if (!IsValidUser(Users.UserName,Users.UserPassword))
